...
const overrides = new Map([
  ...
  [3047, { title: "Матеріали для роботи з учнями з ООП", grade: "1–4 клас", subject: "інклюзивна освіта", materialType: "Комплект для вчителя" }],
  [3126, { title: "Стіна слів на вересень — 2 клас", grade: "2 клас", subject: "українська мова", materialType: "Наочність" }],
  [3148, { title: "Математичні слова-помічники — 2 клас", grade: "2 клас", subject: "математика", materialType: "Наочність" }],
]);
